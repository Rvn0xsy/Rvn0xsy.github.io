...
layout: post
date: '2020-06-28'
permalink: "/archivers/2020-06-28/1"
...
![2020-06-28-22-03-13](https://rvn0xsy.oss-cn-shanghai.aliyuncs.com/0d16f01986d829bd82e3eacf4995a9a5.png)

执行完成，能够看到whoami的结果是SYSTEM权限，通过流量上分析：

![2020-06-28-22-03-27](https://rvn0xsy.oss-cn-shanghai.aliyuncs.com/f4d0641851f1119759d61edd77a789b5.png)
...
![2020-06-28-22-03-40](https://rvn0xsy.oss-cn-shanghai.aliyuncs.com/42a889308009de6201a6ebd7d17a0a58.png)

紧接着，源主机向目标主机进行SMB认证，完成文件的读取（命令执行结果），最终断开连接。

在操作系统的事件查看器中，**（默认情况下）**仅仅捕获了几条Windows认证的日志，关于服务、文件操作、应用程序等都没有相关日志。

![2020-06-28-22-03-53](https://rvn0xsy.oss-cn-shanghai.aliyuncs.com/0b65e37d47b0c29c001d0d4b6d5d67e8.png)
...
![2020-06-28-22-04-33](https://rvn0xsy.oss-cn-shanghai.aliyuncs.com/b9d665e24c38810cece969d9dcc3d80c.png)